...
-   Значительно переработали [команду `merge-reports`](/docs/html-reporter/html-reporter-commands/#merge-reports) — теперь она работает лучше, стабильнее и покрывает больше кейсов
...
[time-travel-guide]: /docs/basic-guides/time-travel/
