...
<table>
    ...
    <tbody>
        <tr>
            <td>name</td>
            <td>`string`</td>
            <td>Required. The name of the plugin npm package.</td>
        </tr>
        <tr>
            <td>component</td>
            <td>`string`</td>
            <td>The name of the React component exported from the plugin.</td>
        </tr>
        <tr>
            <td>point</td>
            <td>`string`</td>
        ...
        <tr>
            <td>position</td>
            <td>`string`</td>
            <td>Position relative to the extension point: `"wrap"`, `"before"`, or `"after"`.</td>
        </tr>
        <tr>
            <td>config</td>
            <td>`object`</td>
            <td>Configuration object passed to the plugin via `pluginOptions.pluginConfig`.</td>
        </tr>
    </tbody>
</table>
