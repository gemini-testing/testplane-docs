...
Используйте плагин [@testplane/browser-version-changer][testplane-browser-version-changer], чтобы управлять определением версии браузера для тестов.
...
-   [Исходники плагина @testplane/browser-version-changer][testplane-browser-version-changer]

[testplane-browser-version-changer]: https://github.com/gemini-testing/testplane-browser-version-changer
