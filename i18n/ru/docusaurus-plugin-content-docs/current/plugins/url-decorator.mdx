...
Используйте плагин [@testplane/url-decorator][url-decorator], чтобы автоматически дополнять урлы в testplane-тестах нужными query-параметрами.
...
-   [Исходники плагина @testplane/url-decorator][url-decorator]
