...
Читайте также наш рецепт «[Как убрать скроллбары из скриншотов](./visual-checks-best-practices/hiding-scrollbars.mdx)».
