...
Для включения селективности достаточно добавить в конфигурацию Testplane секцию [`selectivity`](/docs/reference/config/browsers#selectivity) с параметром `enabled: true`:
