...
Готовые образы могут не включать самые свежие версии браузеров. Чтобы собрать актуальные образы, воспользуйтесь инструкциями из репозитория [`gemini-testing/images`](https://github.com/gemini-testing/images/).
...
2. Через переменные окружения (с ограничением уровня логирования `webdriverio`):
