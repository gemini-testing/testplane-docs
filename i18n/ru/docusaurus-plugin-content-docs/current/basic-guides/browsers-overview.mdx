...
Остальные поддерживаемые настройки смотрите в [официальной документации](https://developer.chrome.com/docs/chromedriver/mobile-emulation).
...
## Локальные браузеры {/* #local-browsers */}
