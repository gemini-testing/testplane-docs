...
Если в Вашем проекте еще нет Testplane, рекомендуем ознакомиться с разделом [быстрого старта][quickstart] или выполнить в директории Вашего проекта команду ниже:
...
Также, для storybook-тестов будет проигнорирована опция [isolation][isolation], чтобы не пресоздавать окружение на каждый тест (это никак не влияет на стабильность тестов).

[build-stories]: https://storybook.js.org/docs/6.4/configure/overview#feature-flags
[html-reporter]: ../../html-reporter/html-reporter-setup/
[isolation]: ../../reference/config/browsers/#isolation
...
[tests-per-session]: ../../reference/config/browsers/#tests_per_session
