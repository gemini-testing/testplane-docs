...
Наиболее распространенный сценарий использования метаинформации — сохранение сслылки на тикет:
...
Ключ `url` Testplane заполняет автоматически: в нём сохраняется адрес страницы, на которой находился браузер в момент завершения теста.
