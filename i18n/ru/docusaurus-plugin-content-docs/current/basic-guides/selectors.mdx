...
Для выбора элементов на основе их положения или состояния, используйте псевдоселекторы.
...
С помощью XPath вы можете навигировать по DOM-дереву.
...
Testing Library — это адаптер популярной философии Testing Library для Testplane. Он предоставляет селекторы, ориентированные на пользовательский опыт (как пользователи находят элементы).
...
Чтобы найти поле ввода по тексту `placeholder`, используйте метод `getByPlaceholderText`.
