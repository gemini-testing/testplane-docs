...
[//]: # "<style>"
[//]: # '.yc-root_theme_light img[src*="-dark-mode-ru"] { display: none }'
[//]: # '.yc-root_theme_dark img[src*="-light-mode-ru"] { display: none }'
[//]: # "</style>"

![Генерация testplane-событий](/img/docs/reference/testplane-events-light-mode-ru.png)

[//]: # "![Генерация testplane-событий](/img/docs/reference/testplane-events-dark-mode-ru.png)"
...
Событие триггерится один раз в мастер-процесс и один раз в каждом воркере.
...
module.exports = {
    ...
    // см. https://testplane.io/ru/docs/v8/basic-guides/managing-browsers/
