...
-   Significantly reworked the [`merge-reports`](/docs/html-reporter/html-reporter-commands/#merge-reports) command — now it works better, more stable, and covers more cases
