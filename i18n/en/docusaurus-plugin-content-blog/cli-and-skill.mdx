...
Learn more about Testplane Skill [in our docs](/docs/ai/toolkit/testplane-skill) or visit the skill's page on [skills.sh](https://www.skills.sh/gemini-testing/testplane-skill/testplane-skill).
...
The new report tools let agents inspect [Testplane HTML reports](/docs/html-reporter/overview) without opening the browser UI. They work with local reports and remote report URLs, including reports published from CI.
...
Try it on one real task: a failing report, a flaky test, or a page where selectors are hard to guess. Visit our [AI Toolkit Docs](/docs/ai/toolkit/testplane-cli) page for more ideas, practical guidance, and examples of how these tools can fit into your workflow.
