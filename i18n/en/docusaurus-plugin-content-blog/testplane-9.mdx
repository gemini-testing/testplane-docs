...
However, you can still use globals without explicit imports by installing the [`@testplane/globals`](https://github.com/gemini-testing/testplane-globals) package.
