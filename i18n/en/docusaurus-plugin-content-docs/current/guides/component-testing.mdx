...
Read more about it in our blog post "[Component Testing][blog-component-testing]".
...
### Step 3: Configure tests to run in the browser (using option [testRunEnv](./config.md#testrunenv))
...
* the [@testplane/global-hook][testplane-global-hook] plugin is temporarily not supported.
</Admonition>
