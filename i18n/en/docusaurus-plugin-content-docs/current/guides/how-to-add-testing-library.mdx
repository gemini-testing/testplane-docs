...
2. Connect the implementation in the testplane configuration in the `prepareBrowser` section
...
After connecting, you will be able to use the search by selectors from `testing-library`, as described in the [official documentation](https://testing-library.com/docs/queries/about/). For example, searching for an element by its text:
...
In the context of found elements, this feature will also be available:
