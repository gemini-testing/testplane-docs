...
<tr><td>[saveHistory](#save_history)</td><td>Boolean</td><td>true</td><td>Save the history of all executed commands. _Replaced to `saveHistoryMode` in testplane@7_.</td></tr>
<tr><td>[saveHistoryMode](#save_history_mode)</td><td>"all" or "none" or "onlyFailed"</td><td>"all"</td><td>Save the history of all executed commands. _Available from testplane@7_.</td></tr>
...
-   `viewport`&mdash;take a screenshot of the current viewport.
-   `fullpage`&mdash;take a screenshot of the entire browser page.
...
<Admonition type="warning">
    Replaced to [saveHistoryMode](#save_history_mode) in testplane@7.
</Admonition>
...
The history is available from the following events&mdash;`TEST_END`, `TEST_PASS`, `TEST_FAIL`&mdash;via `payload`:
...
<Admonition type="warning">Available from testplane@7.</Admonition>

Save the history of all executed commands. By default: `all`.

Available options:

-   `all` &mdash; history is enabled.
-   `none` &mdash; history is disabled
-   `onlyFailed` &mdash; history is saved for failed tests only.
