...
<tr><td>[passive](#passive)</td><td>Boolean</td><td>false</td><td>Makes the browser "passive". In passive browsers, tests do not run by default. _Available from testplane@8.16.0_.</td></tr>
