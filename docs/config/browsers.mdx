...
<tr><td>[passive](#passive)</td><td>Boolean</td><td>false</td><td>Позволяет сделать браузер пассивным. В пассивных браузерах тесты не запускаются по умолчанию. _Доступна с testplane@8.16.0_.</td></tr>
