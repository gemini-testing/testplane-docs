...
<tr><td>beforeEach</td><td>Function</td><td>null</td><td>Асинхронная функция-обработчик, которая будет выполняться перед запуском каждого теста.</td></tr>
<tr><td>afterEach</td><td>Function</td><td>null</td><td>Асинхронная функция-обработчик, которая будет выполняться после завершения каждого теста.</td></tr>
