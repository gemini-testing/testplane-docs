...
[config-browsers]: ../../reference/config/browsers
...
[antialiasing-tolerance]: ../../reference/config/browsers#antialiasing_tolerance
[composite-image]: ../../reference/config/browsers#composite_image
[take-screenshot-on-fails-assert-view-fail]: ../../reference/config/browsers#take_screenshot_on_fails
[take-screenshot-on-fails-mode]: ../../reference/config/browsers#take_screenshot_on_fails_mode
[take-screenshot-on-fails-timeout]: ../../reference/config/browsers#take_screenshot_on_fails_timeout
[http-timeout]: ../../reference/config/browsers#http_timeout
[page-load-timeout]: ../../reference/config/browsers#page_load_timeout
[session-quit-timeout]: ../../reference/config/browsers#session_quit_timeout
