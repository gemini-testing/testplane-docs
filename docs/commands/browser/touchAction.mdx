...
-   **press** &mdash; нужно указать element или координаты (x, y), или и то, и другое
-   **longPress** &mdash; нужно указать element или координаты (x, y), или и то, и другое
-   **tap** &mdash; нужно указать element или координаты (x, y), или и то, и другое
-   **moveTo** &mdash; нужно указать абсолютные координаты (x, y)
-   **wait** &mdash; нужно указать время в миллисекундах
-   **release** &mdash; ничего указывать не нужно
